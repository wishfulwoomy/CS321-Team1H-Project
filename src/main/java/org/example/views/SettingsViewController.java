...
public class SettingsViewController {
     ...
     * loaded.
     * Syncs the initial state of the UI controls with the current Session
     * preferences
     * and sets up a live-update listener for the text size slider.
     */
    @FXML
    ...
    /**
     * Toggles High Contrast mode on or off. Updates the global session and forces
     * both the settings window and the parent application window to redraw their
     * CSS styles.
     *
     * @param event The action event triggered by clicking the high contrast
     *              checkbox.
     */
    @FXML
    ...
    /**
     * Closes the settings dialog window and returns the user to the underlying
     * application.
     *
